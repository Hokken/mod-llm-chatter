-- Add the private player-to-bot whisper event type.
-- The bridge dispatches this as chatter_whisper.process_player_whisper_event.
-- Guarded so the migration is safe to re-run.

SET @has_player_whisper = (
  SELECT COUNT(*)
